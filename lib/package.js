...
(function() {
  ...
  function validateMapping(mapMatch, mapped, pkgName) {
    ...
    else if (mapMatch.substr(0, 2) == './' && mapped.substr(0, mapMatch.length) == mapMatch && (mapMatch[mapMatch.length - 1] != '/' && mapped[mapMatch.length] == '/'))
      throw new Error('Package ' + pkgName + ' has a recursive internal map for "' + mapMatch + '" which is not permitted.');
  }
